...
<template>
    ...
    <p class="name-client"> Favorite Programming Languages
    </p>
  ...
  export default {
    data() {
      return {
        languages: data.languages.favorites
      };
    }
  };
  </script>
...
.card-client {
  ...
  margin: 20px auto 0; /* Center horizontally and add margin-top */
}
